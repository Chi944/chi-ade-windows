...
**Session persistence improvements** - Terminal sessions now consistently use service-backed persistence for better reliability <PRBadge url="https://github.com/superset-sh/superset/pull/1105" />
